...
greyA = uint8(greyA); %uint8 berguna untuk mengonversi dari tipe double ke uint8 (tipe bilangan bulat 8 bit)
...
greyB = uint8(greyB);  %uint8 berguna untuk mengonversi dari tipe double ke uint8 (tipe bilangan bulat 8 bit)
